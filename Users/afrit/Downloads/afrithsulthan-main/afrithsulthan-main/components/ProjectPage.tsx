...
const PROJECT = {
    ...
    longDescription: "Solves the problem of mismatched names, incorrect emails, and missing LinkedIn profiles by validating 500+ employee records in under 10 minutes.",
    demoUrl: "https://database-validator.vercel.app/",
    codeUrl: "#",
    techStack: ["React", "Apollo API", "Node.js", "Tailwind", "PostgreSQL", "Prisma"],
}
...
export default function ProjectPage() {
    return (
        <div className="relative w-full min-h-screen flex items-center justify-center z-20 bg-gray-50 py-24 overflow-hidden">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-blue-100/30 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-purple-100/30 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="flex-1 w-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {PROJECT.techStack.map((tech, i) => (
                                        <motion.span
                                            key={i}
                                            variants={itemVariants}
                                            className="px-3 py-1 bg-white border border-gray-200 rounded-full text-xs font-bold text-gray-600 shadow-sm hover:border-gray-300 transition-colors cursor-default"
                                        >
                                            {tech}
                                        </motion.span>
                                    ))}
                        ...
                        >
                            ...
                            <div className="relative w-full aspect-[16/10] rounded-3xl overflow-hidden shadow-2xl border border-gray-100 group">
                                <Image
                                    src="/images/project-screenshot.png"
                                    alt="Database Validator Dashboard"
                                    fill
                                    className="object-cover object-left-top transform group-hover:scale-105 transition-transform duration-1000 ease-out"
                                    priority
                                />
